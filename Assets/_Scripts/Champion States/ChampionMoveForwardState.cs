...
public class ChampionMoveForwardState : ChampionBaseState
{
    private readonly MoveController _moveController;
    private float _maxTimeToSwitchMoveDirection = 0.11f;
    private float _currentTime = 0.0f;

    public ChampionMoveForwardState(Animator animator, MoveController moveController, IChampionStateSwitcher championStateSwitcher,
    ...
    {
        _currentTime = 0.0f;
        Animator.SetInteger(Constants.Animator.Params.CaracterMoveDirection, Constants.Direction.Right);
