...
public class ChampionRunForwardState : ChampionStaminaState
{
    private readonly MoveController _moveController;
    private readonly float _maxTimeToMoveCancel = 0.1f;
    private float _currentTime = 0.0f;

    public ChampionRunForwardState(Animator animator, IChampionStateSwitcher championStateSwitcher,
